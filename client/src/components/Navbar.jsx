...
const Navbar = () => {
    return (
        <div className='top-4 pt-2 w-full h-20'>
            <div className='flex py-4 ml-2 mr-2 rounded-lg justify-between items-center  bg-[#0e0e10]'>
                ...
                <div className='flex items-center justify-center gap-8'>
                    <div className='flex items-center'>
                        <button className='bg-[#172554] text-white py-2 rounded-md px-2'>Connect</button>
                    </div>
